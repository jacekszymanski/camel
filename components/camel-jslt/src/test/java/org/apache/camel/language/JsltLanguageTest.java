...
/**
 * Ensures that the "jslt" language is compliant with the single input / typed language expectations.
 */
class JsltLanguageTest extends AbstractSingleInputTypedLanguageTest<JsltExpression.Builder, JsltExpression> {

    public static final ObjectMapper MAPPER = new ObjectMapper();

    JsltLanguageTest() {
        super(".foo", LanguageBuilderFactory::jslt);
    }
