 ...
 */
package org.apache.camel.language.jslt;

import org.apache.camel.Expression;
import org.apache.camel.Predicate;
import org.apache.camel.StaticService;
import org.apache.camel.component.jslt.JsltProcessor;
...
@Language("jslt")
public class JsltLanguage extends SingleInputTypedLanguageSupport implements StaticService {
    ...
    public Expression createExpression(String expression) {
        final JsltProcessor answer = new JsltExpression(expression);
    ...
    public Expression createExpression(String expression, Object[] properties) {
        JsltExpression answer = new JsltExpression(expression);
